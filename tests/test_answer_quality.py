...
_TEST_RULES_PAYLOAD = {
    "option_rules": [
        ...
        {
            "needles": ["建设美丽中国", "为主的方针"],
            "answers": ["保护优先", "节约优先", "自然恢复"],
        },
        {"needles": ["从现在到2020年", "决胜期"], "answers": ["建成小康社会"]},
        {"needles": ["复兴之路", "中华民族的昨天"], "answers": ["“雄关漫道真如铁”"]},
        {
            "needles": ["全面深化改革", "总目标"],
            "answers": ["完善和发展中国特色社会主义制度、推进国家治理体系和治理能力现代化"],
        },
        {
            "needles": ["四个伟大", "属于"],
            "answers": ["进行伟大斗争", "建设伟大工程", "推进伟大事业", "实现伟大梦想"],
        },
        {
            "needles": ["2020年7月30日", "高质量发展", "目标定位"],
            "answers": ["更高质量", "更有效率", "更加公平", "更可持续", "更为安全"],
        },
        {
            "needles": ["社会主要矛盾", "已经转化为"],
            "answers": ["人民日益增长的美好生活需要", "不平衡不充分的发展"],
        },
...
class AnswerQualityTests(unittest.TestCase):
    ...
    def test_model_explanation_enumerating_correct_options_does_not_collapse_to_last_label(
        self,
    ) -> None:
